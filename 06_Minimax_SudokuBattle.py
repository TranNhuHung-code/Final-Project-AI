...
class MinimaxBattleApp:
    ...
    def _build_ui(self):
        ...
        self.p1_label = tk.Label(score_frame, text="Player 1 (Bạn): 0 điểm",
                                  font=FONT_TITLE, bg=CARD, fg=COLOR_P1_BG)
        self.p1_label.pack(side="left", padx=20, pady=10)

        self.p2_label = tk.Label(score_frame, text="Player 2 (AI): 0 điểm",
                                  font=FONT_TITLE, bg=CARD, fg=COLOR_P2_BG)
        self.p2_label.pack(side="right", padx=20, pady=10)
