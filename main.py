...
GROUPS_DATA = [
    {
        ...
        "algorithms": [
            ("BFS", "Breadth-First Search", "Tìm kiếm theo chiều rộng", "07_BFS_sudoku.py"),
            ("DFS", "Depth-First Search", "Tìm kiếm theo chiều sâu", "08_DFS_sudoku.py"),
            ("IDS", "Iterative Deepening Search", "Tìm kiếm sâu dần (đại diện nhóm)", "01_IDS_sudoku.py")
        ]
    },
    {
        ...
        "algorithms": [
            ("Greedy", "Greedy Best-First Search", "Tham lam theo heuristic", "09_Greedy_sudoku.py"),
            ("A*", "A* Search", "Tìm kiếm A*", "10_AStar_sudoku.py"),
            ("IDA*", "IDA* (Iterative Deepening A*)", "Kết hợp IDS + heuristic", "02_IDAstar_sudoku.py")
        ]
    },
    {
        ...
        "algorithms": [
            ("Hill Climbing", "Hill-Climbing Search", "Leo đồi tìm cực đại cục bộ", "11_HillClimbing_sudoku.py"),
            ("Local Beam", "Local Beam Search", "Tìm kiếm chùm tia cục bộ", "12_LocalBeam_sudoku.py"),
            ("Sim. Anneal.", "Simulated Annealing", "Luyện kim giả lập", "03_SimulatedAnnealing_sudoku.py")
        ]
    },
    {
        ...
        "algorithms": [
            ("AND-OR", "AND-OR Search", "Tìm kiếm AND-OR", "13_AndOr_sudoku.py"),
            ("Sensorless", "Sensorless Search", "Tìm kiếm không có quan sát", "14_Sensorless_sudoku.py"),
            ("Partial Obs.", "Partially Observable", "Tìm kiếm quan sát một phần", "04_PartiallyObservable_sudoku.py")
        ]
    },
    {
        ...
        "folder": "Nhom5_CSP",
        "algorithms": [
            ("Backtracking", "Backtracking Search", "Tìm kiếm quay lui", "15_Backtracking_sudoku.py"),
            ("Fwd Checking", "Forward Checking", "Kiểm tra ràng buộc tiến", "05_ForwardChecking_sudoku.py"),
    ...
    },
    {
        ...
        "algorithms": [
            ("Minimax", "Minimax", "Người vs Agent (worst-case)", "06_Minimax_SudokuBattle.py"),
            ("Alpha-Beta", "Alpha-Beta Pruning", "Minimax + cắt tỉa α-β", "17_AlphaBeta_SudokuBattle.py"),
            ("Expectimax", "Expectimax", "Người vs Agent (chance node)", "18_Expectimax_SudokuBattle.py")
        ]
    }
]
