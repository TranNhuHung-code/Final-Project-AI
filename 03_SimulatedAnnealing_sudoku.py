...
COLOR_FILLED_BG = "#ffffff"
COLOR_BETTER_BG = "#d6f5d6"        # Nhận lân cận tốt hơn
COLOR_BETTER_TEXT = "#1b5e20"
COLOR_WORSE_BG = "#ffe0b3"         # Nhận lân cận tệ hơn (đặc trưng của SA)
COLOR_WORSE_TEXT = "#8a4b00"
COLOR_REJECT_BG = "#ffd6d6"        # Từ chối lân cận
COLOR_REJECT_TEXT = "#b3261e"
COLOR_RESTART_FLASH = "#d8d6ff"
...
class SimulatedAnnealingVisualizerApp:
    ...
    def _build_ui(self):
        ...
        subtitle = tk.Label(
            self.root,
            text="Nhóm: Local Search   |   Đồ án cuối kỳ môn Trí Tuệ Nhân Tạo",
        ...
        temp_frame = tk.Frame(self.root, bg=COLOR_BG)
        temp_frame.pack(pady=(0, 6))
        tk.Label(temp_frame, text="Nhiệt độ T hiện tại:", font=FONT_LABEL,
                 bg=COLOR_BG, fg="#cbd2d9").pack(side="left", padx=(0, 8))
        self.temp_canvas = tk.Canvas(temp_frame, width=220, height=18, bg="#374151",
                                      highlightthickness=0)
        self.temp_canvas.pack(side="left")
        self.temp_bar = self.temp_canvas.create_rectangle(0, 0, 220, 18, fill="#f97316", width=0)
        self.temp_value_label = tk.Label(temp_frame, text="T0", font=FONT_LABEL,
                                          bg=COLOR_BG, fg="#cbd2d9")
