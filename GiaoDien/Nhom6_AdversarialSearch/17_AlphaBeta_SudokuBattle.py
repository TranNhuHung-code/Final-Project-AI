...
LUẬT CHƠI "SUDOKU BATTLE" (PEAS):
    ...
    - Đây là trò chơi ZERO-SUM 2 NGƯỜI, LUÂN PHIÊN LƯỢT: Agent đóng vai
      ...
      định đóng vai MIN trong quá trình Agent TÍNH TOÁN nước đi.
    - Vì cây trò chơi quá lớn để duyệt hết, Agent dùng ALPHA-BETA CÓ GIỚI
      HẠN ĐỘ SÂU + HÀM ĐÁNH GIÁ ở node lá để tăng tốc độ so với Minimax.
      Chi tiết: xem file alpha_beta_solver.py (AlphaBetaSudokuBattle).
...
CÁCH CHƠI:
    ...
    3. Đến lượt Agent: Agent tự động dùng Alpha-Beta để chọn (ô, số) tốt
...
CÁCH CHẠY:
    python 17_AlphaBeta_SudokuBattle.py
...
class AlphaBetaBattleApp:
    def __init__(self, root):
        ...
        self.game = AlphaBetaSudokuBattle(self.puzzle, self.real_solution,
    ...
    def _build_ui(self):
        ...
        tk.Label(right_frame, text="🧠 Log suy luận Alpha-Beta của Agent",
    ...
    def on_confirm_human_move(self):
        ...
        self.info_label.config(text="Lượt của Agent... Agent đang suy luận bằng Alpha-Beta.")
