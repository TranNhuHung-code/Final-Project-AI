...
COLOR_UNKNOWN_BG = "#ffffff"        # Ô chưa biết chắc (domain > 1)
COLOR_UNKNOWN_TEXT = "#9aa5b1"
COLOR_OBSERVED_BG = "#cfe8ff"       # Ô vừa được sensor quan sát trực tiếp
COLOR_OBSERVED_TEXT = "#1d4ed8"
COLOR_PROPAGATED_BG = "#fff3b0"     # Ô vừa được suy luận ra (cascade) do lan truyền
...
class PartiallyObservableVisualizerApp:
    ...
    def _build_ui(self):
        ...
        subtitle = tk.Label(
            self.root,
            text="Nhóm: Searching in Complex Environments   |   Đồ án cuối kỳ môn Trí Tuệ Nhân Tạo",
        ...
        note = tk.Label(
            ...
            font=("Segoe UI", 10, "italic"), bg=COLOR_BG, fg="#9aa5b1"
        )
        note.pack(pady=(0, 10))
